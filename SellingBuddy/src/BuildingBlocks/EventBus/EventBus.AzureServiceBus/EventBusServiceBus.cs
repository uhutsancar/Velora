...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        public override void Publish(IntegrationEvent @event)
        {
            ...
            var eventStr = JsonConvert.SerializeObject(@event); //dısardan gelen class'ı önce string json nesnesine
            var bodyArr = Encoding.UTF8.GetBytes(eventStr); // daha sonra da json nesnesini body arrey'e cevirdik 
